...
- PortsKiller owns local background-runtime integrations: extend its existing menu and login item instead of adding sibling menu-bar apps or LaunchAgents, and verify Background Items still exposes only PortsKiller.
